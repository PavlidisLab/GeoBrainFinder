...
for i = 1:length(varargin)   
    if mod(i,2) == 1
        ...
        elseif string(varargin{i,1}) == "gemmaLasteeID"
            lastGemmaID = double(varargin{i+1,1});
        else disp(strcat("Typo found in name of parameter: ",varargin{i,1}, ". Use one of: 'fileToSkip', 'runGemma', 'numThreads', or 'gemmaLasteeID'"));
